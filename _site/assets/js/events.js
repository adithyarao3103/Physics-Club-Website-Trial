...
inner+='<div class="event" id = "' + events[i].poster + 'evntidid"><div class="pointer" id = "' + events[i].poster + 'poinidid"></div><div class="date"" id = "' + events[i].poster + 'dateidid">' + events[i].date + '</div><div class="item zoomout"  id="' + events[i].poster + 'itemidid"><center><img class="poster lozad" src="assets/posters/placeholder.jpg" data-src="/assets/posters/' + events[i].poster + '.png"" id = "' + events[i].poster + 'imagidid"></img></center><div class="info"" id = "' + events[i].poster + 'infoidid"><center " id = "' + events[i].poster + 'cntridid"><div class="name"" id = "' + events[i].poster + 'nameidid">' + events[i].name.toUpperCase() + '</div><div class="descr" id = "' + events[i].poster + 'descidid">' + events[i].descr;
if (events[i].reglink != " ") {
